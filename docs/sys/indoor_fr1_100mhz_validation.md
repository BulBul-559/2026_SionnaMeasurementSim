...
### `median_0000 label0p2` SRS-like direct uplink
...
| `/waveform/rx_grid` | `[1, 20, 7, 16, 2, 3276]` |
| `/waveform/tx_grid` | `[1, 20, 7, 2, 2, 3276]` |
...
链路质量。SRS-like full-band sounding 仍是当前 CSI 监督/定位基线；PUSCH-DMRS
proxy 可用于链路功能验证、proxy 对照和后续定位实验。若要称为标准 NR SRS，还需要
补齐 `docs/sys/nr_srs_standard_todo.md` 中的 3GPP SRS 细节。
